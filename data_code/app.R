                ...
                shinydashboard::box(width = 12, background = 'black',
                  valueBox(tags$p('Chennai Super Kings (CSK)', style = 'font-size: 30%;text-align: center;'), 
                    ...
                    valueBox(tags$p('Rising Pune Supergiant (RPS)', style = 'font-size: 30%;text-align: center;'), 
                             div(img(src = 'RPS.jpg', height = '120', width = '160'),style='text-align: center;'), 
                             icon = NULL, width = 2, color = 'black'),
...
# Overview -----------------------------------------------------------------
      ...
      tabItem(tabName = 'summary',
              ...
              shinydashboard::box(title = 'Season Winners',
                  ...
                  collapsed = T,
                  fluidRow(
                    valueBox(tags$p('2008', style = 'font-size: 40%;text-align: center;'), div(img(src = 'RR.jpeg', height = '80', width = '100'),style='text-align: center;'), 
                             icon = NULL, width = 2, color = 'black'),
                    valueBox(tags$p('2009', style = 'font-size: 40%;text-align: center;'), div(img(src = 'DC.jpeg', height = '80', width = '100'),style='text-align: center;'), 
                             icon = NULL, width = 2, color = 'black'),
                    ...
                    valueBox(tags$p('2011', style = 'font-size: 40%;text-align: center;'), div(img(src = 'CSK.jpeg', height = '80', width = '100'),style='text-align: center;'),  
                             icon = NULL, width = 2, color = 'black'),
                    valueBox(tags$p('2012', style = 'font-size: 40%;text-align: center;'), div(img(src = 'KKR.jpeg', height = '80', width = '100'),style='text-align: center;'), 
                             icon = NULL, width = 2, color = 'black'),
                    valueBox(tags$p('2013', style = 'font-size: 40%;text-align: center;'), div(img(src = 'MI.jpeg', height = '80', width = '100'),style='text-align: center;'),  
                             icon = NULL, width = 2, color = 'black'),
                    valueBox(tags$p('2014', style = 'font-size: 40%;text-align: center;'), div(img(src = 'KKR.jpeg', height = '80', width = '100'),style='text-align: center;'), 
                             icon = NULL, width = 2, color = 'black'),
                    valueBox(tags$p('2015', style = 'font-size: 40%;text-align: center;'), div(img(src = 'MI.jpeg', height = '80', width = '100'),style='text-align: center;'),  
                             icon = NULL, width = 2, color = 'black'),
                    valueBox(tags$p('2016', style = 'font-size: 40%;text-align: center;'), div(img(src = 'SRH.png', height = '80', width = '100'),style='text-align: center;'),  
                             icon = NULL, width = 2, color = 'black'),
                    valueBox(tags$p('2017', style = 'font-size: 40%;text-align: center;'), div(img(src = 'MI.jpeg', height = '80', width = '100'),style='text-align: center;'),  
                             icon = NULL, width = 2, color = 'black'),
                    valueBox(tags$p('2018', style = 'font-size: 40%;text-align: center;'), div(img(src = 'CSK.jpeg', height = '80', width = '100'),style='text-align: center;'),  
                             icon = NULL, width = 2, color = 'black'),
                    valueBox(tags$p('2019', style = 'font-size: 40%;text-align: center;'), div(img(src = 'MI.jpeg', height = '80', width = '100'),style='text-align: center;'),  
                             icon = NULL, width = 2, color = 'black')
                    )
              ),
              
              shinydashboard::box(title = 'Orange Cap Winners',
                  width = 12,
                  background  = 'orange', 
                  solidHeader = T, 
                  collapsed = T,
                  ...
                  valueBox(tags$p('2008 - Shaun Marsh (KXIP)', style = 'font-size: 30%;text-align: center;'), div(img(src = "Shaun.jpeg", 
                       height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                  valueBox(tags$p('2009 - Matthew Hayden (CSK)',style = 'font-size: 30%;text-align: center;'), div(img(src = "hayden.jpg", 
                       height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                  valueBox(tags$p('2010 -  Sachin Tendulkar (MI)', style = 'font-size: 30%;text-align: center;'), div(img(src = "sachin.jpg", 
                       height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                  ...
                  valueBox(tags$p('2012 - Chris Gayle (RCB)', style = 'font-size: 30%;text-align: center;'), div(img(src = "gayle.jpg", 
                       height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),                                                                                              
                  valueBox(tags$p('2013 - Michael Hussey (CSK)', style = 'font-size: 30%;text-align: center;'), div(img(src = "hussey.jpg",
                      height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                  valueBox(tags$p('2014 - Robin Uthappa (KKR)', style = 'font-size: 30%;text-align: center;'), div(img(src = "uttappa.jpg", 
                      height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                  valueBox(tags$p('2015 - David Warner (SRH)', style = 'font-size: 30%;text-align: center;'), div(img(src = "warner.jpg", 
                      height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                  valueBox(tags$p('2016 - Virat Kohli (RCB)', style = 'font-size: 30%;text-align: center;'), div(img(src = "virat.jpg", 
                      height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                  valueBox(tags$p('2017 - David Warner (SRH)', style = 'font-size: 30%;text-align: center;'), div(img(src = "warner.jpg", height = "80", width = "100"),style="text-align: center;"), 
                           icon = NULL, width = 2, color = "black"),
                  valueBox(tags$p('2018 - Kane Williamson (SRH)', style = 'font-size: 30%;text-align: center;'), div(img(src = "kane.jpg", 
                      height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                  valueBox(tags$p('2019 - David Warner (SRH)', style = 'font-size: 30%;text-align: center;'), div(img(src = "warner.jpg", 
                      height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'))
              ),
              
              shinydashboard::box(title = 'Purple Cap Winners',
                  width = 12,
                  background  = 'purple', 
                  solidHeader = T, 
                  collapsible = T,
                  collapsed = T,
                  shinydashboard::box( background  = 'black',width = 12,
                  valueBox(tags$p("2008 - Sohail Tanvir (RR)", style = "font-size: 30%;text-align: center;"), div(img(src = "tanvir.jpg", height = "80", width = "100"),style="text-align: center;"), 
                           icon = NULL, width = 2, color = "black"),
                  valueBox(tags$p("2009 - R. P. Singh (DC)",style = "font-size: 30%;text-align: center;"), div(img(src = "rp.jpg", height = "80", width = "100"),style="text-align: center;"), 
                           icon = NULL, width = 2, color = "black"),
                  valueBox(tags$p("2010 -  Pragyan Ojha (DC)", style = "font-size: 30%;text-align: center;"), div(img(src = "ojha.jpg", height = "80", width = "100"),style="text-align: center;"), 
                           icon = NULL, width = 2, color = "black"),
                  valueBox(tags$p("2011 - Lasith Malinga (MI)", style = "font-size: 30%;text-align: center;"), div(img(src = "malinga.jpg", height = "80", width = "100"),style="text-align: center;"), 
                           icon = NULL, width = 2, color = "black"),
                  valueBox(tags$p("2012 - Morne Morkel (DD)", style = "font-size: 30%;text-align: center;"), div(img(src = "morkel.jpg", height = "80", width = "100"),style="text-align: center;"), 
                           icon = NULL, width = 2, color = "black"),
                  valueBox(tags$p("2013 - Dwayne Bravo (CSK)", style = "font-size: 30%;text-align: center;"), div(img(src = "bravo.jpg", height = "80", width = "100"),style="text-align: center;"), 
                           icon = NULL, width = 2, color = "black"),
                  valueBox(tags$p("2014 - Mohit Sharma (CSK)", style = "font-size: 30%;text-align: center;"), div(img(src = "mohit.jpg", height = "80", width = "100"),style="text-align: center;"), 
                           icon = NULL, width = 2, color = "black"),
                  valueBox(tags$p("2015 - Dwayne Bravo (CSK)", style = "font-size: 30%;text-align: center;"), div(img(src = "bravo.jpg", height = "80", width = "100"),style="text-align: center;"), 
                           icon = NULL, width = 2, color = "black"),
                  valueBox(tags$p("2016 - Bhuvneshwar Kumar (SRH)", style = "font-size: 30%;text-align: center;"), div(img(src = "buvi.jpg", height = "80", width = "100"),style="text-align: center;"), 
                           icon = NULL, width = 2, color = "black"),
                  valueBox(tags$p("2017 - Bhuvneshwar Kumar (SRH)", style = "font-size: 30%;text-align: center;"), div(img(src = "buvi.jpg", height = "80", width = "100"),style="text-align: center;"), 
                           icon = NULL, width = 2, color = "black"),
                  valueBox(tags$p("2018 - Andrew Tye (KXIP)", style = "font-size: 30%;text-align: center;"), div(img(src = "tye.jpg", height = "80", width = "100"),style="text-align: center;"), 
                           icon = NULL, width = 2, color = "black"),
                  valueBox(tags$p("2019 - Imran Tahir (CSK)", style = "font-size: 30%;text-align: center;"), div(img(src = "tahir.jpeg", height = "80", width = "100"),style="text-align: center;"), 
                           icon = NULL, width = 2, color = "black")
                  )
              ),
      ),
